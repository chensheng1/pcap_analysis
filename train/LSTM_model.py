...
class LSTM_model:
    ...
    def main(self,texts_train1,text_test1,target_train,target_test):
        ...
        saver.save(sess, "D:\\学习资料\\代码\\PCAP_analysis\\model\\model_mu.ckpt")
        len1=len(text_test1)
        ...
        print(LSTM_model.tf_confusion_metrics(y_pre, target_test, sess,
                                              feed_dict={_X: text_test1[:].reshape((len1, 1, x)),
    ...
    def tf_confusion_metrics(predict, real, session, feed_dict):
        ...
        return accuracy, recall, precision, f1_score, fpr, fnr
